  ...
  return (
    <footer className="bg-dark text-light pt-5 mt-5">
      <div className="container">
        <div className="row">   
          ...
          <div className="col-md-4">
            <Image src={logo} style={{width:'40%',backgroundColor:'#fff', padding:'5px',borderRadius:'5px',marginBottom:'15px'}}/>
          
            <p>If you have any question, please contact us at</p>
            <Link href="mailto:Suncareshiningsolution@gmail.com" className="text-light d-block mb-2">
            Suncareshiningsolution@gmail.com
            </Link>
            <address>
            Plot No. -24, Dinesh Rd Ajmer Rd, Madrampura, Pincode-302006, Jaipur, Rajasthan
              
            </address>
            <Link href="tel:+918306420304" className="text-light">
              +91 8306420304
            </Link>
          </div>
      ...
      <div className="bg-dangers text-light text-center py-3 mt-4">
        <p className="mb-0">Copyright &copy; {new Date().getFullYear()} Suncareshining solution private limited. All Rights Reserved</p>
      </div>
    </footer>
  );
}
