...
export default function Header() {
  ...
  const handleLogout = async () => {
    try {
      await apiPost("api/auth3/logOut3");
  ...
  return (
    <div className="headerfix">
      {/* Top Bar */}
      <div className="bg-dangers text-black py-2 px-4 d-flex justify-content-end align-items-center">
        {isLoggedIn ? (
          <button
            onClick={handleLogout}
            className="btn btn-link text-black mx-3 hover:text-primary"
          >
            Logout
          </button>
        ) : (
          <Link href="/login" className="text-black hover:text-primary mx-3">
            Login
          </Link>
        )}
            ...
            >
              <ul className="navbar-nav mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link
                    href="/"
                    className="text-black hover:text-primary mx-3"
                  >
                    Home
                  </Link>
                </li>
